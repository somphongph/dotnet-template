...
namespace Infrastructure.CacheRepositories
{
    public class RedisRepository : ICacheRepository
    {
        ...
        {
            var expireShort = Convert.ToInt32(_configuration.GetSection("RedisSettings:ExpireShort").Value);
        ...
        {
            var expireLong = Convert.ToInt32(_configuration.GetSection("RedisSettings:ExpireLong").Value);
